...
<div class="btn-group">
   <?php if($resultado_rol["crear_articulos"]==1){
       ?>
            <a href="crear_articulo.php" type="button" class="btn btn-secondary " >Crear Insumos</a>
       <?php
   } 
  
       ?>
            <a href="inventario.php" type="button" class="btn btn-secondary">Lista de insumos</a>
        <?php
   ...
   if($resultado_rol["ver_articulos_en_movimiento"]==1){
        ?>
            <a href="articulos_en_movimiento.php" type="button" class="btn btn-secondary ">Insumos en movimiento</a>
        <?php
   }    
